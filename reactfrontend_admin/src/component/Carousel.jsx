                                ...
                                <nav className="navbar navbar-default">
                                            <div className="container-fluid">
                                                <div className="navbar-header">
                                                    ...
                                                    <Link to="#" className="navbar-brand">Carousel Display</Link>
                                                </div>
                                                ...
                                                <div className="container-fluid">
                                                    <form className="form-horizontal" onSubmit={this.tambahData} encType="multipart/form-data">
                                                        <fieldset> 
                                                            ...
                                                            <div className="form-group">
                                                                    <label htmlFor="description" className="col-sm-2 control-label">Text 1</label>
                                                            ...
                                                            <div className="form-group">
                                                                    <label htmlFor="description" className="col-sm-2 control-label">Text 2</label>
                                                                    <div className="col-sm-8">
                                                                        <textarea ref="descproduk" style={{height:250}} placeholder="Deskripsi" className="form-control" />
                                                                    </div>
                                                                </div> 
                                                            ...
                                                            <div className="form-group">
                                                                    <label htmlFor="description" className="col-sm-2 control-label">Text 3</label>
                                                                    <div className="col-sm-8">
                                                                        <textarea ref="descproduk" style={{height:250}} placeholder="Deskripsi" className="form-control" />
                                                                    </div>
                                                                </div> 
