                                ...
                                <nav className="navbar navbar-default">
                                            <div className="container-fluid">
                                                <div className="navbar-header">
                                                    ...
                                                    <Link to="./Dashboard" className="navbar-brand" >Profile of Mine</Link>
                                                </div>
                                            ...
                                            <div className="col-lg-4 col-md-5">
                                                <div className="card card-user">
                                                    ...
                                                    <div className="author">
                                                        <img className="avatar border-white" src="assets/img/faces/5.jpg" alt="..." />
                                                        ...
                                                        <ul className="list-unstyled team-members">
                                                            <li>
                                                                <div className="row">
                                                                    ...
                                                                    <div className="col-xs-6">Alif<br />
                                                            ...
                                                            <li>
                                                                <div className="row">
                                                                    <div className="col-xs-3">
                                                                        <div className="avatar">
                                                                            <img src="assets/img/faces/3.jpg" alt="Circle Image" className="img-circle img-no-padding img-responsive" />
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <div className="row">
                                                                    ...
                                                                    <div className="col-xs-6">Jony<br />
